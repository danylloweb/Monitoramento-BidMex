...
/**
 *
 * @type {{after_15_days: boolean, loops: number, round_trip: boolean, companies: {avianca: boolean, tam: boolean, gol: boolean, azul: boolean}}}
 */
const config = {
    after_15_days: false,
    loops: 1,
 ...
 * @returns {Promise<void>}
 */
const basicTests = async function (page, config) {
    await go(page);
    await login(page);
